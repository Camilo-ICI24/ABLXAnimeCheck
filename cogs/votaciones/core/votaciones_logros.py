...
from cogs.votaciones.core.votaciones_gustos import registrar_voto_gustos, tiene_gustos_caoticos
from cogs.votaciones.core.votaciones_votos import total_animes_votados
