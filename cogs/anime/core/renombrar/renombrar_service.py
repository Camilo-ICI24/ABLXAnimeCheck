...
from cogs.anime.core.renombrar.renombrar_validaciones import (validar_existencia_actual, 
                                                              validar_colision_nuevo, extraer_nombres)
from cogs.anime.core.renombrar.renombrar_embeds import (embed_ya_en_uso, embed_nombres_identicos, 
                                                        embed_ok)
